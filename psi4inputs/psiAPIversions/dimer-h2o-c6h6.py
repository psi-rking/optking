...
0 1
 ...
 --
0 1
 connectivity_mat    0.8853463281       -5.2235996493        0.5504918473
 connectivity_mat    1.8139169342       -2.1992967152        3.8040686146
 connectivity_mat    2.8624456357       -4.1143863257        0.5409035710
 connectivity_mat   -0.6240195463       -4.8153482424        2.1904642137
 connectivity_mat   -0.1646305764       -3.3031992532        3.8141619690
 connectivity_mat    3.3271056135       -2.6064153737        2.1669340785
...
psi4_options = {
  ...
  'frag_ref_atoms': [ 
    ...
    [[1, 2, 3, 4, 5, 6],[2],[6]]  # reference atoms are center of ring, connectivity_mat, connectivity_mat frag2
   ]
}
