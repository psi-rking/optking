...
class OptParams(object):
    ...
    # interfrag_mode  = string_option( 'interfrag_mode' )
    # interfrag_hess  = string_option( 'interfrag_hess' )
    ...
    def __init__(self, uod):
        ...
        # self.frozen_distance = uod.get('FROZEN_DISTANCE','')
        ...
        # self.fixed_distance = uod.get("FIXED_DISTANCE", "")
        ...
        # self.fixed_bend    = uod.get("FIXED_BEND", "")
        ...
        # self.fixed_dihedral = uod.get("FIXED_DIHEDRAL","")
        ...
        # self.print_trajectory_xyz = uod.get('PRINT_TRAJECTORY_XYZ', False)
        # Symmetry tolerance for testing whether a mode is symmetric.
        # self.symm_tol("SYMM_TOL", 0.05)
        #
        ...
        # coordinates. atom_a primary difference is that in ``MULTI`` mode, the interfragment
        ...
        # self.inter_frag = uod.get('FREEZE_INTERFRAG', False)
        ...
        # self.add_auxiliary_bonds = uod.get('ADD_AUXILIARY_BONDS', True)
        # This factor times standard covalent distance is used to add extra stretch coordinates.
        # self.auxiliary_bond_factor = uod.get('AUXILIARYBOND_FACTOR', 2.5)
        ...
        # self.interfrag_hess = uod.get('INTERFRAG_HESS', 'DEFAULT')
        ...
        # self.final_geom_write = uod.get('FINAL_GEOM_WRITE', False)
        # Do test atom_b matrix?
        self.test_B = uod.get('TEST_B', False)
        # Do test derivative atom_b matrix?
        ...
        #
        # Assume RFO means self-RFO for transition states.
        if self.opt_type == 'TS':
        ...
        # if self.fragment_mode == 'MULTI' and 'RFO_NORMALIZATION_MAX' not in uod:
        # self.rfo_normalization_max = 1.0e5
        ...
        # self.interfrag_collinear_tol = 0.01
    ...
    def update_dynamic_level_parameters(self, run_level):
        ...
        *   badly defined internal coordinate or derivative
        ...
        if run_level == 0:
            ...
            self.opt_coordinates = 'REDUNDANT'
            self.consecutiveBackstepsAllowed = 1
            self.step_type = 'RFO'
