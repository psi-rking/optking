...
def test_irc_HCN(direction, point, energy):
    ...
    os.system(f"cp HCN_irc.hess stdout.default.{os.getpid()}.hess")
    # find Hessian
    psi4.set_options(
        {
            "basis": "STO-3G",
...
def test_irc_CH5(direction, point, energy):
    ...
    os.system(f"cp CH5_irc.hess stdout.default.{os.getpid()}.hess")
    # find Hessian
    psi4.set_options(
        {
            "basis": "STO-3G",
            ...
            "opt_type": "IRC",
            "irc_direction": direction,
            # "hessian_file": f"stdout.default.{os.getpid()}.hess",
            "cart_hess_read": True,
            # "scf_type": "pk",
            # "hessian_write": True,
            # "full_hess_every": 0,
