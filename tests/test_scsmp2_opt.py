...
def test_scsmp3_opt():
    ...
    assert psi4.compare_values(REF_nuc, this_nuc, 3, "Nuclear Repulsion Energy (a.u.)");  #TEST
    assert psi4.compare_values(REF_scf, this_scf, 6, "SCF Energy (a.u.)"); #TEST
    assert psi4.compare_values(REF_scsomp3, this_energy, 6, "SCS-OMP3 Total Energy (a.u.)"); #TEST
...
def test_sosmp2_opt():
    ...
    assert psi4.compare_values(REF_nuc, this_nuc, 3, "Nuclear Repulsion Energy (a.u.)"); #TEST
    assert psi4.compare_values(REF_scf, this_scf,  6, "SCF Energy (a.u.)"); #TEST
    assert psi4.compare_values(REF_sosomp2, this_energy, 6, "SOS-OMP2 Total Energy (a.u.)"); #TEST
